...
def load_rag_chain():
    ...
    load_dotenv()
    # Works with .env locally OR Streamlit Cloud secrets
...
Answer the user's question using the following context retrieved from DBS Help & Support articles.

Rules:
- Be concise and practical. Use bullet points or numbered steps where appropriate.
...
- If the context has partial information, extract as much useful detail as possible and provide a helpful answer. Supplement with general DBS knowledge where appropriate.
- If the context has very little relevant information, provide the best guidance you can based on what is available, and suggest the user visit www.dbs.com.sg/personal/support or call the hotline at 1800 111 1111 for more details.
- Never say "the context does not contain" or "not available in the provided context" — instead, share whatever relevant info you have and direct users to the appropriate resources for more details.
...
<div class="main-header">
    <h1>🏦 DBS Help & Support Chatbot</h1>
...
# ── RAG vs LLM Comparison Mode ────────────────────────────────────────────────
    ...
    query = st.text_input("Enter your question:", placeholder="e.g. How do I set up PayNow?")
